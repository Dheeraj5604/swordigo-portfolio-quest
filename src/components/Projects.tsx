...
import { ExternalLink, Sword, Brain, TrendingUp, Users } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-4 animate-fade-in">
            <div className="flex items-center justify-center gap-3 mb-4">
              <Sword className="w-8 h-8 text-primary animate-glow" />
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Epic projects forged in the fires of innovation and creativity
            </p>
          </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <Badge 
                            variant="outline" 
                            className={`border-${quest.color}/50 text-${quest.color}`}
                          >
                            {quest.difficulty}
                          </Badge>
                        </div>
