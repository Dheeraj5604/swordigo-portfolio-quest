  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="space-y-8">
          ...
          <Card className="p-8 bg-card/50 backdrop-blur border-border">
            ...
            <div className="space-y-4 text-foreground/80">
              ...
              <p>
                ...
                you will find me practicing calisthenics, playing guitar, or discovering new music to fuel 
                the creative spirit.
              </p>
            </div>
          </Card>
        ...
        {/* Abilities Grid */}
        <div>
          <h3 className="text-3xl font-bold text-center mb-8 hero-text">Character Abilities</h3>
